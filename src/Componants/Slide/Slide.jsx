      ...
      <div className='flex w-full h-full bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)] p-6 md:p-20 lg:p-[100px]'>
        <div className=''>
          ...
          <Link to='/createAssignment'>
            <button className='px-5 py-4 mt-4 text-lg font-medium bg-gradient-to-r from-[#7E90FE] to-[#9873FF] text-white capitalize transition-colors duration-300 transform bg-gray-600 rounded-md lg:w-auto hover:bg-gray-500 focus:outline-none focus:bg-gray-500'>
              Create Assignment
            </button>
          </Link>
        </div>
